...
function love.load()
  ...
  --explosion_img = love.graphics.newImage("gfx/explosion.png")
  --explosion = newAnimation(explosion_img, 128, 128, 0.07, 16)
  --explosion:play()
  ...
  jet:setColor(255, 255, 255, 255, 127, 127, 255, 0)
  jet:stop()
  ...
  smoke:setSize(0.4, 0.7)
  smoke:setSizeVariation(1)
  smoke:setColor(191, 191, 191, 255, 191, 191, 191, 0)
  smoke:stop()
  ...
  blood:setSize(0.1, 0.7)
  blood:setSizeVariation(1)
  blood:setColor(255, 0, 0, 255, 255, 0, 0, 0)
  blood:stop()
  ...
  explosion:setSize(0.1, 0.7)
  explosion:setSizeVariation(1)
  explosion:setColor(255, 255, 0, 255, 255, 127, 0, 0)
  explosion:stop()
  ...
  expsmoke:setSize(0.4, 0.7)
  expsmoke:setSizeVariation(1)
  expsmoke:setColor(191, 191, 191, 255, 191, 191, 191, 0)
  expsmoke:stop()
end
